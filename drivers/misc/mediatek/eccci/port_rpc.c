...
#if __HCT_SIM_HOTPLUG_SUPPORT__
...
#ifndef __HCT_SIM_HOTPLUG_SUPPORT__
#error "sim hotplug need defined in config header"
#endif
...
#else
        CCCI_INF_MSG(-1, RPC, "hct sim hotplug close-node is NULL\n");
#endif
}
