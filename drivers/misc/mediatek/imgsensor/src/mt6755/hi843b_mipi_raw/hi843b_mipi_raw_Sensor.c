...
#if 0//Hi843B_OTP_FUNCTION //Hi-843B OPT
...
#if 0//Hi843B_OTP_FUNCTION //Hi-843B OPT fuction begin
...
//  wb_golden_bg_l = 0x09;//
 ...
 //     + wb_golden_r_h + wb_golden_r_l + wb_golden_b_h + wb_golden_b_l + wb_golden_g_h + wb_golden_g_l ) % 0xFF + 1;
	...
	rg_golden_value = 0x0278; //((wb_golden_rg_h << 8)|wb_golden_rg_l);
	bg_golden_value = 0x0252; //((wb_golden_bg_h << 8)|wb_golden_bg_l);
...
write_cmos_sensor(0x0026, 0x0048); 
write_cmos_sensor(0x002c, 0x09d7); //0d98->0d97 0708update
