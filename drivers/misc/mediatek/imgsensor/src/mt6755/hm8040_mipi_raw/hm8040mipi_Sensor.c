...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = HM8040MIPI_SENSOR_ID,
...
static imgsensor_struct imgsensor = {
    ...
    .i2c_write_id = 0x68,//record current sensor's i2c write id
};
...
UINT32 HM8040MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
