...
#define PFX "OV8856"
#define SENSOR_OTP_SWITCH 1

#if SENSOR_OTP_SWITCH
extern void ov8856_otp_load_lsc(void);
extern void ov8856_2lane_write_back_otp_awb(void);
#endif
...
#if SENSOR_OTP_SWITCH
	ov8856_otp_load_lsc();
	ov8856_2lane_write_back_otp_awb();
#endif
/*
	#ifdef OV8856R1AOTP
...
UINT32 OV8856_MIPI_RAW_2LANE_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
