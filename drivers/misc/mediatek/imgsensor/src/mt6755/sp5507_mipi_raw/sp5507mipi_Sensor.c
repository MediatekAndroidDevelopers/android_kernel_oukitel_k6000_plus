...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = SP5507MIPI_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
...
{
	LOG_INF("sp5507_Sensor_Init_2lane E\n");
