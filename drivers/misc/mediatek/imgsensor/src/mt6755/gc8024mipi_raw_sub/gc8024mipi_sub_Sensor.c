...
#include "gc8024mipi_sub_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "GC8024_sub_camera_sensor"
#define LOG_1 LOG_INF("GC8024_sub\n")
/****************************   Modify end    *******************************************/
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC8024MIPI_SUB_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0x5427612a,        //checksum value for Camera Auto Test
...
{
    LOG_INF("GC8024 enable: %d\n", enable);

    if (enable) {
        write_cmos_sensor(0xfe, 0x00);
        write_cmos_sensor(0x8c, 0x19);		
    } else {
        write_cmos_sensor(0xfe, 0x00);
...
UINT32 GC8024MIPI_RAW_SUB_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
