...
#define EEPROM             DW9763

#define EEPROM_READ_ID    	(0xb0)
#define I2C_SPEED           (400)  //CAT24C512 can support 1Mhz

#define MAX_OFFSET          (0xffff)
#define TOTAL_DATA_SIZE           (496+876)

static BYTE eeprom_data[TOTAL_DATA_SIZE] = {0};
...
bool ov16880_read_eeprom( u16 addr, BYTE* data, u32 size)
{
	addr = 0x0801;
