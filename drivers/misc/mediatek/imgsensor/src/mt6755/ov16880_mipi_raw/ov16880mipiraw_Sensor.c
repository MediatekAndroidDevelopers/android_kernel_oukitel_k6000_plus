...
//#define sensor_flip
//#define OV16880_FPTPDAFSUPPORT   //for pdaf switch

static DEFINE_SPINLOCK(imgsensor_drv_lock);

extern bool ov16880_read_eeprom( u16 addr, BYTE* data, u32 size);
...
#ifdef OV16880_FPTPDAFSUPPORT
			ov16880_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
#endif
			break;
