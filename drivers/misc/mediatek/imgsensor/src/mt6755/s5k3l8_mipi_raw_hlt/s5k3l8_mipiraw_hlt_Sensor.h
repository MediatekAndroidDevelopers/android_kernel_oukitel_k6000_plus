 ...
 *
 ****************************************************************************/
#ifndef _S5K3L8_MIPI_HLT_SENSOR_H
#define _S5K3L8_MIPI_HLT_SENSOR_H
...
extern bool S5K3L8_HLT_read_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
