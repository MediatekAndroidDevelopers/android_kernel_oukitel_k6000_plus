...
static int hi553_otp_apply(void)
{
	...
	RG_ratio_golden = 404;//(hi553_otp.wb_data[6] << 8) | (hi553_otp.wb_data[7] & 0x03FF);
	BG_ratio_golden = 336;//(hi553_otp.wb_data[8] << 8) | (hi553_otp.wb_data[9] & 0x03FF);
	wbcheck = hi553_otp.wb_data[29];
	checksum = ((hi553_otp.wb_data[0] + hi553_otp.wb_data[1] + hi553_otp.wb_data[2] + hi553_otp.wb_data[3] + hi553_otp.wb_data[4] + hi553_otp.wb_data[5] + hi553_otp.wb_data[6] + hi553_otp.wb_data[7] + hi553_otp.wb_data[8] +hi553_otp.wb_data[9] +hi553_otp.wb_data[10]+hi553_otp.wb_data[11]) & 0xFF) + 1;
