...
LOG_INF("Enter init\n");
 ...
 write_cmos_sensor(0x0006, 0x09BC); //frame_length_lines_h						
 write_cmos_sensor(0x0008, 0x0ED8); //line_length_pck_h 						
 write_cmos_sensor(0x000E, 0x0000); //image_orient								
 ...
 write_cmos_sensor(0x0074, 0x09B6); //Coarse integration time					
 ...
 write_cmos_sensor(0x0A04, 0x014A); //ISP enable								
