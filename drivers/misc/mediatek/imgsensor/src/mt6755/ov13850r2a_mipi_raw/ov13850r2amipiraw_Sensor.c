...
#include "ov13850r2amipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV13850R2A_camera_sensor"
#define LOG_1 LOG_INF("OV13850R2A,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13850R2A_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0xbde6b5f8,//359b1edd 0xf86cfdf4,        //checksum value for Camera Auto Test
