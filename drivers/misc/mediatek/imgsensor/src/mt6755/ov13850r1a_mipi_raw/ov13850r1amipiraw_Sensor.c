...
#define PFX "OV13850R1A_camera_sensor"
#define LOG_1 LOG_INF("OV13850R1A,MIPI 4LANE\n")
...
int ov13850_chip_ver_r1a = OV13850_R2A;
//sensor otp
extern void otp_cali_r1a(unsigned char writeid);

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13850R1A_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0x542b274d,//0x359b1edd 0xf86cfdf4,        //checksum value for Camera Auto Test
...
#else
    kal_uint16 sensor_id=0x0;
    sensor_id = (read_cmos_sensor(0x300A) << 8) | read_cmos_sensor(0x300B);

    return read_cmos_sensor(0x302a)+sensor_id;
#endif
}
...
//	kal_uint16 iGain=gain;
	...
	if (ov13850_chip_ver_r1a == OV13850_R1A)
	{
	...
	else if(ov13850_chip_ver_r1a == OV13850_R2A)
	{
...
*/
int capture_first_flag_r1a = 0;
int pre_currefps_r1a = 0;
static void capture_setting(kal_uint16 currefps)
{
    LOG_INF("E! currefps:%d\n",currefps);

if (pre_currefps_r1a != currefps)
{
	capture_first_flag_r1a = 0;
	pre_currefps_r1a = currefps;
}
else
{
	capture_first_flag_r1a = 1;
}
if (capture_first_flag_r1a == 0)
{
...
static kal_uint32 open(void)
{
    ...
    if (imgsensor_info.sensor_id != sensor_id)
		...
		{
				LOG_INF("----R1A---- \n");
				ov13850_chip_ver_r1a = OV13850_R1A;
		}else if((read_cmos_sensor(0x302a))==0xb2)
		{
				LOG_INF("----R2A---- \n");
				ov13850_chip_ver_r1a = OV13850_R2A;
		}
    /* initail sequence write in  */
    sensor_init();
	  //for OTP
	  otp_cali_r1a(imgsensor.i2c_write_id);
	  write_cmos_sensor(0x0100, 0x00);
