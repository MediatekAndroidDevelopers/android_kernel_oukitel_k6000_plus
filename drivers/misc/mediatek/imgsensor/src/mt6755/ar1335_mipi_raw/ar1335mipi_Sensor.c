 ...
 * ---------
 *     AR1335mipi_Sensor.c
 *read_cmos_sensor_2read_cmos_sensor_2read_cmos_sensor_2
 * Project:
 * --------
 *     ALPS
 *
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .normal_video = {
        ...
        .mipi_data_lp2hs_settle_dc = 14,//unit , ns 4k
        .max_framerate = 300,
    },
	.hs_video = {
		.pclk = 440000000,
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("-----ar1335, i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
                return ERROR_NONE;
            }
            LOG_INF("---ar1335, Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
