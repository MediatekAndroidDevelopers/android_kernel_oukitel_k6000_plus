...
#elif defined(CONFIG_USB_C_SWITCH_PI5USB30216A)
struct usbc_pin_ctrl {
	struct pinctrl_state *typec_as_int;
	struct pinctrl_state *typec_usb_id;
};
#elif defined(CONFIG_USB_C_SWITCH_PI5USB30216C)
struct usbc_pin_ctrl {
	struct pinctrl_state *typec_as_int;
	struct pinctrl_state *typec_usb_id;
};
...
struct usbtypc {
	...
	struct work_struct  usbid_eint_work;
};
#elif defined(CONFIG_USB_C_SWITCH_PI5USB30216C)
struct usbtypc {
	int irqnum;
