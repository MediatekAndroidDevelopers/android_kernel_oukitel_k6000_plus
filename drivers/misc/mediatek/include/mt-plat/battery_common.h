...
#define MAX_CV_CHARGING_TIME			(8*60*60)/* 3hr */  //stop charger 9 stop 1 by hsl 
...
/*****************************************************************************
*   hct battery temperature standard
    charging info ,like temperatue, charging current, re-charging voltage, CV threshold would be reconfigurated.
    Temperature hysteresis default 6C.
    Reference table:
    degree    AC Current    USB current    CV threshold    Recharge Vol    hysteresis condition
    > 55       no charging current,             X                    X                     <54(Down)
    45~60     600mA         450mA             4.1V               4V                   <39(Down) >60(Up)
    10~45     600mA         450mA             4.2V               4.1V                <10(Down) >45(Up)
    0~10       600mA         450mA             4.1V               4V                   <0(Down)  >16(Up)
    -10~0     200mA         200mA             4V                  3.9V                <-10(Down) >6(Up)
...
****************************************************************************/
typedef enum {
	HCT_TEMP_BELOW_NEG_10 = 0,
	HCT_TEMP_NEG_10_TO_POS_0,
	HCT_TEMP_POS_0_TO_POS_50,
	HCT_TEMP_POS_50_TO_POS_55,
	HCT_TEMP_ABOVE_POS_55,
	HCT_TEMP_STATE_UNKNOWN
} hct_temp_state_enum;

#define TEMP_DALTA_THRES_DEGREE    2

#define HCT_TEMP_NEG_10_THRESHOLD  (-10)

#define TEMP_POS_60_THRESHOLD  50
#define TEMP_POS_60_THRES_MINUS_X_DEGREE 47

#define TEMP_POS_50_THRESHOLD  50
...
extern PMU_STATUS do_charger_state_machine(void);
#endif
...
struct battery_custom_data {
	...
	int high_battery_4400_voltage_support;
