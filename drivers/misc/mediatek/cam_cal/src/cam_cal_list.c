...
#ifndef __HCT_CUSTOM_CAM_S5K3L2_OTP_SUPPORT__
#define __HCT_CUSTOM_CAM_S5K3L2_OTP_SUPPORT__ 0
#endif
#ifndef __HCT_CUSTOM_CAM_IMX258_OTP_SUPPORT__
#define __HCT_CUSTOM_CAM_IMX258_OTP_SUPPORT__ 0
#endif

#define MTK_MAX_CID_NUM 3
unsigned int mtkCidList[MTK_MAX_CID_NUM] = {
#if __HCT_CUSTOM_CAM_S5K3L2_OTP_SUPPORT__
	0x00000005,/*custom Format*/
#elif __HCT_CUSTOM_CAM_IMX258_OTP_SUPPORT__
	0x01,/*Single MTK Format*/
#else
...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{S5K3L2_SENSOR_ID, 0xB0, CMD_BRCB032GWZ, cam_cal_check_mtk_cid},
	{IMX214_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
	{S5K2X8_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
	{IMX258_SENSOR_ID, 0xB0, CMD_BRCB032GWZ, cam_cal_check_mtk_cid},
...
#if __HCT_CUSTOM_CAM_S5K3L2_OTP_SUPPORT__ || __HCT_CUSTOM_CAM_IMX258_OTP_SUPPORT__
