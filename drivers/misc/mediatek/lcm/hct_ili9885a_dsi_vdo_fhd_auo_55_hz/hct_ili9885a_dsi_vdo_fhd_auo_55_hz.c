...
static struct LCM_setting_table lcm_initialization_setting[] = {
	  ...
	  {0xEC,  7,{0x76,0x1E,0x32,0x00,0x46,0x00,0x00}},  //black display while video stop
...
// zhangxiaofei add for test
    ...
    params->dsi.lcm_esd_check_table[3].para_list[2] = 0xea;
    params->dsi.lcm_esd_check_table[3].para_list[3] = 0x22;
    
    params->dsi.lcm_esd_check_table[4].cmd          = 0xd5; 
    params->dsi.lcm_esd_check_table[4].count        = 4; 
    params->dsi.lcm_esd_check_table[4].para_list[0] = 0x8b;
    params->dsi.lcm_esd_check_table[4].para_list[1] = 0x00;
    params->dsi.lcm_esd_check_table[4].para_list[2] = 0x00;
    params->dsi.lcm_esd_check_table[4].para_list[3] = 0x00;
    
    params->dsi.lcm_esd_check_table[5].cmd          = 0xea; 
    params->dsi.lcm_esd_check_table[5].count        = 4; 
    params->dsi.lcm_esd_check_table[5].para_list[0] = 0x51;
    params->dsi.lcm_esd_check_table[5].para_list[1] = 0x00;
    params->dsi.lcm_esd_check_table[5].para_list[2] = 0x00;
    params->dsi.lcm_esd_check_table[5].para_list[3] = 0x00;
} 
...
LCM_DRIVER hct_ili9885a_dsi_vdo_fhd_auo_55_hz = 
{
    .name           = "hct_ili9885a_dsi_vdo_fhd_auo_55_hz",
