...
static void lcm_get_params(LCM_PARAMS * params)
{
	...
	params->dsi.noncont_clock_period = 0;
...
//	printk("HCT_lcm_setbacklight level = %d\n", level);
   ...
   printk("HCT_lcm_setbacklight level = %d\n", level);
    ...
    //list[2] = (unsigned char)level;

    //dsi_set_cmdq_V2(0xFD, 3, &list, 1);	
	data_array[0] = 0x00043902;         //
	data_array[1] = 0xFF0051FD;         ///2015.10.26确定使用0X14，使用0X24屏显示左右镜像
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_rm67120_dsi_vdo_hd_gvo_55_gx = 
{
	.name			= "hct_rm67120_dsi_vdo_hd_gvo_55_gx",
