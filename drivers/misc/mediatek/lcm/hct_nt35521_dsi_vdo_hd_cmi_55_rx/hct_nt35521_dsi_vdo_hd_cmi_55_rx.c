...
static void lcm_get_params(LCM_PARAMS *params)
{
        ...
        params->dsi.PLL_CLOCK = 233; //240 238this value must be in MTK suggested table
...
static struct LCM_setting_table lcm_initialization_setting[] = {
        ...
        {0xC8,1,{0x80}},//83
{0xB1,2,{0x60,0x21}}, 					// Set Resolution: 720x1280, 0x21 follow scan			
...
{0xBC,2,{0xA0,0x00}},					// A0=+5.0V,VGMP,  VGSP setting ,VGMP < AVDD-0.5V ,james 20150818 			
{0xBD,2,{0xA0,0x00}},					// A0=-5.0V,VGMN, VGSN setting, VGMN > AVEE+0.5V ,james 20150818 			
									
{0xBE,1,{0x6e}}, 						//VCOM adjust //JAMES 20150916, average Vcom=4Ah			
...
{0xD1,5,{0x00,0x05,0x09,0x00,0x00}},		
{0xD2,5,{0x10,0x05,0x0F,0x00,0x00}},		
{0xED,1,{0x03}},		
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_nt35521_dsi_vdo_hd_cmi_55_rx= 
{
    .name			= "hct_nt35521_dsi_vdo_hd_cmi_55_rx",
