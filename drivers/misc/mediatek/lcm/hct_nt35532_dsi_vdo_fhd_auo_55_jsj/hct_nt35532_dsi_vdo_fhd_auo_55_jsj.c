...
NT35596_DCS_write_1A_1P(0x06,0x10); //50
...
//NT35596_DCS_write_1A_1P(0x13,0x4B);//VCOM
//NT35596_DCS_write_1A_1P(0x14,0x40);//VCOM  OTPÉÕÂŒ
...
LCM_DRIVER hct_nt35532_dsi_vdo_fhd_auo_55_jsj =
{
    .name            = "hct_nt35532_dsi_vdo_fhd_auo_55_jsj",
