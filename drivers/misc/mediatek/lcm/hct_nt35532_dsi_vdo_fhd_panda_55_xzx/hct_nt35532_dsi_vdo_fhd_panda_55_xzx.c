...
NT35596_DCS_write_1A_1P(0x13,0x50);
NT35596_DCS_write_1A_1P(0x14,0x50);
...
NT35596_DCS_write_1A_1P(0x78,0x1A);                 
NT35596_DCS_write_1A_1P(0x79,0x00);                 
NT35596_DCS_write_1A_1P(0x7A,0x3D);                 
NT35596_DCS_write_1A_1P(0x7B,0x00);                 
NT35596_DCS_write_1A_1P(0x7C,0x58);                 
NT35596_DCS_write_1A_1P(0x7D,0x00);                
NT35596_DCS_write_1A_1P(0x7E,0x6E);                 
NT35596_DCS_write_1A_1P(0x7F,0x00);                 
NT35596_DCS_write_1A_1P(0x80,0x81);                 
NT35596_DCS_write_1A_1P(0x81,0x00);                 
NT35596_DCS_write_1A_1P(0x82,0x92);                 
NT35596_DCS_write_1A_1P(0x83,0x00);                 
NT35596_DCS_write_1A_1P(0x84,0xA2);                 
NT35596_DCS_write_1A_1P(0x85,0x00);                 
NT35596_DCS_write_1A_1P(0x86,0xB0);                 
NT35596_DCS_write_1A_1P(0x87,0x00);                 
NT35596_DCS_write_1A_1P(0x88,0xE1);                 
NT35596_DCS_write_1A_1P(0x89,0x01);                 
NT35596_DCS_write_1A_1P(0x8A,0x08);                 
NT35596_DCS_write_1A_1P(0x8B,0x01);                 
NT35596_DCS_write_1A_1P(0x8C,0x47);                 
NT35596_DCS_write_1A_1P(0x8D,0x01);                 
NT35596_DCS_write_1A_1P(0x8E,0x79);                 
NT35596_DCS_write_1A_1P(0x8F,0x01);                 
NT35596_DCS_write_1A_1P(0x90,0xC9);                 
NT35596_DCS_write_1A_1P(0x91,0x02 );                
NT35596_DCS_write_1A_1P(0x92,0x07);                
NT35596_DCS_write_1A_1P(0x93,0x02);                 
NT35596_DCS_write_1A_1P(0x94,0x09);                 
NT35596_DCS_write_1A_1P(0x95,0x02);                
NT35596_DCS_write_1A_1P(0x96,0x42);                 
NT35596_DCS_write_1A_1P(0x97,0x02);                 
NT35596_DCS_write_1A_1P(0x98,0x80);                 
NT35596_DCS_write_1A_1P(0x99,0x02);                 
NT35596_DCS_write_1A_1P(0x9A,0xA6);                 
NT35596_DCS_write_1A_1P(0x9B,0x02);                 
NT35596_DCS_write_1A_1P(0x9C,0xDA);                 
NT35596_DCS_write_1A_1P(0x9D,0x02);                 
NT35596_DCS_write_1A_1P(0x9E,0xFB);                 
NT35596_DCS_write_1A_1P(0x9F,0x03);                 
NT35596_DCS_write_1A_1P(0xA0,0x2D);                 
NT35596_DCS_write_1A_1P(0xA2,0x03);               
NT35596_DCS_write_1A_1P(0xA3,0x3A);                 
NT35596_DCS_write_1A_1P(0xA4,0x03);                 
NT35596_DCS_write_1A_1P(0xA5,0x49);                 
NT35596_DCS_write_1A_1P(0xA6,0x03);                 
NT35596_DCS_write_1A_1P(0xA7,0x5D);                 
NT35596_DCS_write_1A_1P(0xA9,0x03);                 
NT35596_DCS_write_1A_1P(0xAA,0x7A);                 
NT35596_DCS_write_1A_1P(0xAB,0x03);                 
NT35596_DCS_write_1A_1P(0xAC,0x96);                 
NT35596_DCS_write_1A_1P(0xAD,0x03);                 
NT35596_DCS_write_1A_1P(0xAE,0xB4);                 
NT35596_DCS_write_1A_1P(0xAF,0x03);                 
NT35596_DCS_write_1A_1P(0xB0,0xCA);                 
NT35596_DCS_write_1A_1P(0xB1,0x03);                 
NT35596_DCS_write_1A_1P(0xB2,0xCD);                 
 //GAMMA RED-                                                    
NT35596_DCS_write_1A_1P(0xB3,0x00);                 
NT35596_DCS_write_1A_1P(0xB4,0x01);                 
NT35596_DCS_write_1A_1P(0xB5,0x00);                 
NT35596_DCS_write_1A_1P(0xB6,0x1A);                 
NT35596_DCS_write_1A_1P(0xB7,0x00);                 
NT35596_DCS_write_1A_1P(0xB8,0x3D);                 
NT35596_DCS_write_1A_1P(0xB9,0x00);                 
NT35596_DCS_write_1A_1P(0xBA,0x58);                 
NT35596_DCS_write_1A_1P(0xBB,0x00);                 
NT35596_DCS_write_1A_1P(0xBC,0x6E);                 
NT35596_DCS_write_1A_1P(0xBD,0x00);                 
NT35596_DCS_write_1A_1P(0xBE,0x81);                 
NT35596_DCS_write_1A_1P(0xBF,0x00);                 
NT35596_DCS_write_1A_1P(0xC0,0x92);                 
NT35596_DCS_write_1A_1P(0xC1,0x00);                 
NT35596_DCS_write_1A_1P(0xC2,0xA2);                 
NT35596_DCS_write_1A_1P(0xC3,0x00);                 
NT35596_DCS_write_1A_1P(0xC4,0xB0);                 
NT35596_DCS_write_1A_1P(0xC5,0x00);                 
NT35596_DCS_write_1A_1P(0xC6,0xE1);                 
NT35596_DCS_write_1A_1P(0xC7,0x01);                 
NT35596_DCS_write_1A_1P(0xC8,0x08);                 
NT35596_DCS_write_1A_1P(0xC9,0x01);                 
NT35596_DCS_write_1A_1P(0xCA,0x47);                 
NT35596_DCS_write_1A_1P(0xCB,0x01);                 
NT35596_DCS_write_1A_1P(0xCC,0x79);                 
NT35596_DCS_write_1A_1P(0xCD,0x01);                 
NT35596_DCS_write_1A_1P(0xCE,0xC9);                 
NT35596_DCS_write_1A_1P(0xCF,0x02);               
NT35596_DCS_write_1A_1P(0xD0,0x07);                 
NT35596_DCS_write_1A_1P(0xD1,0x02);                 
NT35596_DCS_write_1A_1P(0xD2,0x09);                 
NT35596_DCS_write_1A_1P(0xD3,0x02);                 
NT35596_DCS_write_1A_1P(0xD4,0x42);                 
NT35596_DCS_write_1A_1P(0xD5,0x02);                 
NT35596_DCS_write_1A_1P(0xD6,0x80);                 
NT35596_DCS_write_1A_1P(0xD7,0x02);                 
NT35596_DCS_write_1A_1P(0xD8,0xA6);                 
NT35596_DCS_write_1A_1P(0xD9,0x02);                 
NT35596_DCS_write_1A_1P(0xDA,0xDA);                 
NT35596_DCS_write_1A_1P(0xDB,0x02);                 
NT35596_DCS_write_1A_1P(0xDC,0xFB);                 
NT35596_DCS_write_1A_1P(0xDD,0x03);                 
NT35596_DCS_write_1A_1P(0xDE,0x2D);                 
NT35596_DCS_write_1A_1P(0xDF,0x03);                 
NT35596_DCS_write_1A_1P(0xE0,0x3A);                 
NT35596_DCS_write_1A_1P(0xE1,0x03);                 
NT35596_DCS_write_1A_1P(0xE2,0x49);                 
NT35596_DCS_write_1A_1P(0xE3,0x03);                 
NT35596_DCS_write_1A_1P(0xE4,0x5D);                 
NT35596_DCS_write_1A_1P(0xE5,0x03);                 
NT35596_DCS_write_1A_1P(0xE6,0x7A);                 
NT35596_DCS_write_1A_1P(0xE7,0x03);                 
NT35596_DCS_write_1A_1P(0xE8,0x96);                 
NT35596_DCS_write_1A_1P(0xE9,0x03);                 
NT35596_DCS_write_1A_1P(0xEA,0xB4);                 
NT35596_DCS_write_1A_1P(0xEB,0x03);                 
NT35596_DCS_write_1A_1P(0xEC,0xCA);                 
NT35596_DCS_write_1A_1P(0xED,0x03);                 
NT35596_DCS_write_1A_1P(0xEE,0xCD);                 
 //GAMMA Green+                                                  
NT35596_DCS_write_1A_1P(0xEF,0x00);                 
NT35596_DCS_write_1A_1P(0xF0,0xA5);                 
NT35596_DCS_write_1A_1P(0xF1,0x00);                 
NT35596_DCS_write_1A_1P(0xF2,0xAC);                 
NT35596_DCS_write_1A_1P(0xF3,0x00);                 
NT35596_DCS_write_1A_1P(0xF4,0xB9);                 
NT35596_DCS_write_1A_1P(0xF5,0x00);                 
NT35596_DCS_write_1A_1P(0xF6,0xC6);                 
NT35596_DCS_write_1A_1P(0xF7,0x00);                 
NT35596_DCS_write_1A_1P(0xF8,0xD1);                 
NT35596_DCS_write_1A_1P(0xF9,0x00);                 
NT35596_DCS_write_1A_1P(0xFA,0xDC);                 
 //Command2 Page1                                                
NT35596_DCS_write_1A_1P(0xFF,0x02);                 
NT35596_DCS_write_1A_1P(0xFB,0x01);                 
NT35596_DCS_write_1A_1P(0x00,0x00);                 
NT35596_DCS_write_1A_1P(0x01,0xE8);                 
NT35596_DCS_write_1A_1P(0x02,0x00);                 
NT35596_DCS_write_1A_1P(0x03,0xF1);                 
NT35596_DCS_write_1A_1P(0x04,0x00);                 
NT35596_DCS_write_1A_1P(0x05,0xF9);                 
NT35596_DCS_write_1A_1P(0x06,0x01);                 
NT35596_DCS_write_1A_1P(0x07,0x1C);                 
NT35596_DCS_write_1A_1P(0x08,0x01);                 
NT35596_DCS_write_1A_1P(0x09,0x3C);                 
NT35596_DCS_write_1A_1P(0x0A,0x01);                 
NT35596_DCS_write_1A_1P(0x0B,0x6C);                 
NT35596_DCS_write_1A_1P(0x0C,0x01);                 
NT35596_DCS_write_1A_1P(0x0D,0x95);                 
NT35596_DCS_write_1A_1P(0x0E,0x01);                 
NT35596_DCS_write_1A_1P(0x0F,0xDB);                 
NT35596_DCS_write_1A_1P(0x10,0x02);                 
NT35596_DCS_write_1A_1P(0x11,0x14);                 
NT35596_DCS_write_1A_1P(0x12,0x02);                 
NT35596_DCS_write_1A_1P(0x13,0x16);                
NT35596_DCS_write_1A_1P(0x14,0x02);                 
NT35596_DCS_write_1A_1P(0x15,0x4C);                 
NT35596_DCS_write_1A_1P(0x16,0x02);                 
NT35596_DCS_write_1A_1P(0x17,0x88);                 
NT35596_DCS_write_1A_1P(0x18,0x02);                
NT35596_DCS_write_1A_1P(0x19,0xAF);                 
NT35596_DCS_write_1A_1P(0x1A,0x02);                 
NT35596_DCS_write_1A_1P(0x1B,0xE4);                 
NT35596_DCS_write_1A_1P(0x1C,0x03);                 
NT35596_DCS_write_1A_1P(0x1D,0x05);                 
NT35596_DCS_write_1A_1P(0x1E,0x03);                 
NT35596_DCS_write_1A_1P(0x1F,0x3A);                 
NT35596_DCS_write_1A_1P(0x20,0x03);                
NT35596_DCS_write_1A_1P(0x21,0x49);                 
NT35596_DCS_write_1A_1P(0x22,0x03);                 
NT35596_DCS_write_1A_1P(0x23,0x5A);                 
NT35596_DCS_write_1A_1P(0x24,0x03);                 
NT35596_DCS_write_1A_1P(0x25,0x6C);                 
NT35596_DCS_write_1A_1P(0x26,0x03);                 
NT35596_DCS_write_1A_1P(0x27,0x82);                 
NT35596_DCS_write_1A_1P(0x28,0x03);                 
NT35596_DCS_write_1A_1P(0x29,0x9B);                 
NT35596_DCS_write_1A_1P(0x2A,0x03);                 
NT35596_DCS_write_1A_1P(0x2B,0xB6);                 
NT35596_DCS_write_1A_1P(0x2D,0x03);                 
NT35596_DCS_write_1A_1P(0x2F,0xCA);                 
NT35596_DCS_write_1A_1P(0x30,0x03);                 
NT35596_DCS_write_1A_1P(0x31,0xCD);                 
 //GAMMA Green-                                                  
NT35596_DCS_write_1A_1P(0x32,0x00);                 
NT35596_DCS_write_1A_1P(0x33,0xA5);                 
NT35596_DCS_write_1A_1P(0x34,0x00);                 
NT35596_DCS_write_1A_1P(0x35,0xAC);                 
NT35596_DCS_write_1A_1P(0x36,0x00);                
NT35596_DCS_write_1A_1P(0x37,0xB9);                 
NT35596_DCS_write_1A_1P(0x38,0x00);                 
NT35596_DCS_write_1A_1P(0x39,0xC6);                 
NT35596_DCS_write_1A_1P(0x3A,0x00);                 
NT35596_DCS_write_1A_1P(0x3B,0xD1);                 
NT35596_DCS_write_1A_1P(0x3D,0x00);                 
NT35596_DCS_write_1A_1P(0x3F,0xDC);                 
NT35596_DCS_write_1A_1P(0x40,0x00);                 
NT35596_DCS_write_1A_1P(0x41,0xE8);                 
NT35596_DCS_write_1A_1P(0x42,0x00);                 
NT35596_DCS_write_1A_1P(0x43,0xF1);                 
NT35596_DCS_write_1A_1P(0x44,0x00);                 
NT35596_DCS_write_1A_1P(0x45,0xF9);                 
NT35596_DCS_write_1A_1P(0x46,0x01);                 
NT35596_DCS_write_1A_1P(0x47,0x1C);                 
NT35596_DCS_write_1A_1P(0x48,0x01);                 
NT35596_DCS_write_1A_1P(0x49,0x3C);                 
NT35596_DCS_write_1A_1P(0x4A,0x01);                 
NT35596_DCS_write_1A_1P(0x4B,0x6C);                 
NT35596_DCS_write_1A_1P(0x4C,0x01);                 
NT35596_DCS_write_1A_1P(0x4D,0x95);                 
NT35596_DCS_write_1A_1P(0x4E,0x01);                 
NT35596_DCS_write_1A_1P(0x4F,0xDB);                 
NT35596_DCS_write_1A_1P(0x50,0x02);                 
NT35596_DCS_write_1A_1P(0x51,0x14);                 
NT35596_DCS_write_1A_1P(0x52,0x02);                 
NT35596_DCS_write_1A_1P(0x53,0x16);                
NT35596_DCS_write_1A_1P(0x54,0x02);                 
NT35596_DCS_write_1A_1P(0x55,0x4C);                 
NT35596_DCS_write_1A_1P(0x56,0x02);                 
NT35596_DCS_write_1A_1P(0x58,0x88);                 
NT35596_DCS_write_1A_1P(0x59,0x02);                 
NT35596_DCS_write_1A_1P(0x5A,0xAF);                 
NT35596_DCS_write_1A_1P(0x5B,0x02);                 
NT35596_DCS_write_1A_1P(0x5C,0xE4);                 
NT35596_DCS_write_1A_1P(0x5D,0x03);                 
NT35596_DCS_write_1A_1P(0x5E,0x05);                 
NT35596_DCS_write_1A_1P(0x5F,0x03);                 
NT35596_DCS_write_1A_1P(0x60,0x3A);                 
NT35596_DCS_write_1A_1P(0x61,0x03);                 
NT35596_DCS_write_1A_1P(0x62,0x49);                 
NT35596_DCS_write_1A_1P(0x63,0x03);                 
NT35596_DCS_write_1A_1P(0x64,0x5A);                 
NT35596_DCS_write_1A_1P(0x65,0x03);                 
NT35596_DCS_write_1A_1P(0x66,0x6C);                 
NT35596_DCS_write_1A_1P(0x67,0x03);                 
NT35596_DCS_write_1A_1P(0x68,0x82);                 
NT35596_DCS_write_1A_1P(0x69,0x03);                 
NT35596_DCS_write_1A_1P(0x6A,0x9B);                 
NT35596_DCS_write_1A_1P(0x6B,0x03);                 
NT35596_DCS_write_1A_1P(0x6C,0xB6);                 
NT35596_DCS_write_1A_1P(0x6D,0x03);                 
NT35596_DCS_write_1A_1P(0x6E,0xCA);                 
NT35596_DCS_write_1A_1P(0x6F,0x03);                 
NT35596_DCS_write_1A_1P(0x70,0xCD);                 
 //GAMMA Blue+                                                   
NT35596_DCS_write_1A_1P(0x71,0x00);                 
NT35596_DCS_write_1A_1P(0x72,0x2C);                 
NT35596_DCS_write_1A_1P(0x73,0x00);                 
NT35596_DCS_write_1A_1P(0x74,0x3B);                 
NT35596_DCS_write_1A_1P(0x75,0x00);                 
NT35596_DCS_write_1A_1P(0x76,0x54);                 
NT35596_DCS_write_1A_1P(0x77,0x00);                
NT35596_DCS_write_1A_1P(0x78,0x6A);                 
NT35596_DCS_write_1A_1P(0x79,0x00);                 
NT35596_DCS_write_1A_1P(0x7A,0x7B);                 
NT35596_DCS_write_1A_1P(0x7B,0x00);                 
NT35596_DCS_write_1A_1P(0x7C,0x8C);                 
NT35596_DCS_write_1A_1P(0x7D,0x00);                 
NT35596_DCS_write_1A_1P(0x7E,0x9D);                 
NT35596_DCS_write_1A_1P(0x7F,0x00);                 
NT35596_DCS_write_1A_1P(0x80,0xAA);                 
NT35596_DCS_write_1A_1P(0x81,0x00);                 
NT35596_DCS_write_1A_1P(0x82,0xB5);                 
NT35596_DCS_write_1A_1P(0x83,0x00);                 
NT35596_DCS_write_1A_1P(0x84,0xE3);                 
NT35596_DCS_write_1A_1P(0x85,0x01);                 
NT35596_DCS_write_1A_1P(0x86,0x0B);                 
NT35596_DCS_write_1A_1P(0x87,0x01);                 
NT35596_DCS_write_1A_1P(0x88,0x45);                 
NT35596_DCS_write_1A_1P(0x89,0x01);                 
NT35596_DCS_write_1A_1P(0x8A,0x75);                 
NT35596_DCS_write_1A_1P(0x8B,0x01);                 
NT35596_DCS_write_1A_1P(0x8C,0xC5);                 
NT35596_DCS_write_1A_1P(0x8D,0x02);                 
NT35596_DCS_write_1A_1P(0x8E,0x05);                 
NT35596_DCS_write_1A_1P(0x8F,0x02);                 
NT35596_DCS_write_1A_1P(0x90,0x07);                 
NT35596_DCS_write_1A_1P(0x91,0x02);                 
NT35596_DCS_write_1A_1P(0x92,0x41);                 
NT35596_DCS_write_1A_1P(0x93,0x02);                 
NT35596_DCS_write_1A_1P(0x94,0x80);                 
NT35596_DCS_write_1A_1P(0x95,0x02);                 
NT35596_DCS_write_1A_1P(0x96,0xA8);                 
NT35596_DCS_write_1A_1P(0x97,0x02);                 
NT35596_DCS_write_1A_1P(0x98,0xDF);                 
NT35596_DCS_write_1A_1P(0x99,0x03);                 
NT35596_DCS_write_1A_1P(0x9A,0x05);                 
NT35596_DCS_write_1A_1P(0x9B,0x03);                 
NT35596_DCS_write_1A_1P(0x9C,0x49);                 
NT35596_DCS_write_1A_1P(0x9D,0x03);                 
NT35596_DCS_write_1A_1P(0x9E,0x60);                 
NT35596_DCS_write_1A_1P(0x9F,0x03);                 
NT35596_DCS_write_1A_1P(0xA0,0x85);                 
NT35596_DCS_write_1A_1P(0xA2,0x03);                 
NT35596_DCS_write_1A_1P(0xA3,0xA6);                 
NT35596_DCS_write_1A_1P(0xA4,0x03);                 
NT35596_DCS_write_1A_1P(0xA5,0xBC);                 
NT35596_DCS_write_1A_1P(0xA6,0x03);                 
NT35596_DCS_write_1A_1P(0xA7,0xBD);                 
NT35596_DCS_write_1A_1P(0xA9,0x03);                 
NT35596_DCS_write_1A_1P(0xAA,0xBE);                 
NT35596_DCS_write_1A_1P(0xAB,0x03);                 
NT35596_DCS_write_1A_1P(0xAC,0xCA);                 
NT35596_DCS_write_1A_1P(0xAD,0x03);                 
NT35596_DCS_write_1A_1P(0xAE,0xCD);                 
 //GAMMA Blue-                                                   
NT35596_DCS_write_1A_1P(0xAF,0x00);                 
NT35596_DCS_write_1A_1P(0xB0,0x2C);                 
NT35596_DCS_write_1A_1P(0xB1,0x00);                 
NT35596_DCS_write_1A_1P(0xB2,0x3B);                 
NT35596_DCS_write_1A_1P(0xB3,0x00);                 
NT35596_DCS_write_1A_1P(0xB4,0x54);                 
NT35596_DCS_write_1A_1P(0xB5,0x00);                 
NT35596_DCS_write_1A_1P(0xB6,0x6A);                 
NT35596_DCS_write_1A_1P(0xB7,0x00);                 
NT35596_DCS_write_1A_1P(0xB8,0x7B);                 
NT35596_DCS_write_1A_1P(0xB9,0x00);                 
NT35596_DCS_write_1A_1P(0xBA,0x8C);                 
NT35596_DCS_write_1A_1P(0xBB,0x00);                 
NT35596_DCS_write_1A_1P(0xBC,0x9D);                 
NT35596_DCS_write_1A_1P(0xBD,0x00);                 
NT35596_DCS_write_1A_1P(0xBE,0xAA);                 
NT35596_DCS_write_1A_1P(0xBF,0x00);                 
NT35596_DCS_write_1A_1P(0xC0,0xB5);                 
NT35596_DCS_write_1A_1P(0xC1,0x00);                 
NT35596_DCS_write_1A_1P(0xC2,0xE3);                 
NT35596_DCS_write_1A_1P(0xC3,0x01);                 
NT35596_DCS_write_1A_1P(0xC4,0x0B);                 
NT35596_DCS_write_1A_1P(0xC5,0x01);                 
NT35596_DCS_write_1A_1P(0xC6,0x45);                 
NT35596_DCS_write_1A_1P(0xC7,0x01);                 
NT35596_DCS_write_1A_1P(0xC8,0x75);                 
NT35596_DCS_write_1A_1P(0xC9,0x01);                 
NT35596_DCS_write_1A_1P(0xCA,0xC5);                 
NT35596_DCS_write_1A_1P(0xCB,0x02);                 
NT35596_DCS_write_1A_1P(0xCC,0x05);                 
NT35596_DCS_write_1A_1P(0xCD,0x02);                 
NT35596_DCS_write_1A_1P(0xCE,0x07);                 
NT35596_DCS_write_1A_1P(0xCF,0x02);                 
NT35596_DCS_write_1A_1P(0xD0,0x41);                 
NT35596_DCS_write_1A_1P(0xD1,0x02);                 
NT35596_DCS_write_1A_1P(0xD2,0x80);                 
NT35596_DCS_write_1A_1P(0xD3,0x02);                 
NT35596_DCS_write_1A_1P(0xD4,0xA8);                 
NT35596_DCS_write_1A_1P(0xD5,0x02);                 
NT35596_DCS_write_1A_1P(0xD6,0xDF);                 
NT35596_DCS_write_1A_1P(0xD7,0x03);                 
NT35596_DCS_write_1A_1P(0xD8,0x05);                 
NT35596_DCS_write_1A_1P(0xD9,0x03);                 
NT35596_DCS_write_1A_1P(0xDA,0x49);                 
NT35596_DCS_write_1A_1P(0xDB,0x03);                 
NT35596_DCS_write_1A_1P(0xDC,0x60);                 
NT35596_DCS_write_1A_1P(0xDD,0x03);                 
NT35596_DCS_write_1A_1P(0xDE,0x85);                 
NT35596_DCS_write_1A_1P(0xDF,0x03);                 
NT35596_DCS_write_1A_1P(0xE0,0xA6);                 
NT35596_DCS_write_1A_1P(0xE1,0x03);                 
NT35596_DCS_write_1A_1P(0xE2,0xBC);                 
NT35596_DCS_write_1A_1P(0xE3,0x03);                 
NT35596_DCS_write_1A_1P(0xE4,0xBD);                 
NT35596_DCS_write_1A_1P(0xE5,0x03);                 
NT35596_DCS_write_1A_1P(0xE6,0xBE);                 
NT35596_DCS_write_1A_1P(0xE7,0x03);                 
NT35596_DCS_write_1A_1P(0xE8,0xCA);                 
NT35596_DCS_write_1A_1P(0xE9,0x03);                 
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_sync_active				= 4;   //5  3 14 16 
...
LCM_DRIVER hct_nt35532_dsi_vdo_fhd_panda_55_xzx = 
{
    .name	    = "hct_nt35532_dsi_vdo_fhd_panda_55_xzx",
