...
NT35596_DCS_write_1A_1P(0x06,0x6A);//64
NT35596_DCS_write_1A_1P(0x07,0xC6);
NT35596_DCS_write_1A_1P(0x0D,0x69);//89
NT35596_DCS_write_1A_1P(0x0E,0x89);//89
...
//NT35596_DCS_write_1A_1P(0x13,0x7E);  //vcom 6F 7E 
//NT35596_DCS_write_1A_1P(0x14,0x7E); //7E
//PRE1
...
#if defined(BUILD_LK)
	printf("hct_nt35532_dsi_vdo_fhd_auo_55_rx adc = %x adcdata= %x %x, ret=%d, ADC_MIN_VALUE=%x\r\n",rawdata, adcdata[0], adcdata[1],ret, ADC_MIN_VALUE);
#else
	printk("hct_nt35532_dsi_vdo_fhd_auo_55_rx adc = %x adcdata= %x %x, ret=%d, ADC_MIN_VALUE=%x\r\n",rawdata, adcdata[0], adcdata[1],ret, ADC_MIN_VALUE);
#endif

	if(rawdata < 0x100 && (ret==0))
	{	 
...
LCM_DRIVER hct_nt35532_dsi_vdo_fhd_auo_55_rx =
{
    .name            = "hct_nt35532_dsi_vdo_fhd_auo_55_rx",
