...
#define FL_EN_PIN    		0
#define FL_PWM_PIN    		1
#define FL_SUB_EN_PIN		2
#define FL_SUB_PWM_PIN    		3


//extern void flashlight_gpio_as_pwm(int pin, int config);
//extern void flashlight_gpio_output(int pin, int level);

extern int flashlight_gpio_pwm_start(int pwm_no,int duty);
extern int flashlight_gpio_as_get_pwm_no(int gpio_no);
extern int flashlight_gpio_pwm_end(int pwm_no);
