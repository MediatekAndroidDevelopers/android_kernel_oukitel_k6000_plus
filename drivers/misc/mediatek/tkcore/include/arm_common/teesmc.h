...
#define T6SMC_RPC_ENABLE_SPI_CLK	6
#define T6SMC_RETURN_RPC_ENABLE_SPI_CLK	TEESMC_RPC_VAL(T6SMC_RPC_ENABLE_SPI_CLK)

#define T6SMC_RPC_DISABLE_SPI_CLK	7
#define T6SMC_RETURN_RPC_DISABLE_SPI_CLK	TEESMC_RPC_VAL(T6SMC_RPC_DISABLE_SPI_CLK)
