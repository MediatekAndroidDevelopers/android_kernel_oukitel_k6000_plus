...
#if defined(CONFIG_ONEKEY_REBOOT_NORMAL_MODE)&& defined(CONFIG_TWOKEY_REBOOT_NORMAL_MODE)
	#error "CONFIG_ONEKEY_REBOOT_NORMAL_MODE and CONFIG_TWOKEY_REBOOT_OTHER_MODE can't be opened at the same time"
#else
#endif

#if defined(CONFIG_ONEKEY_REBOOT_OTHER_MODE)&& defined(CONFIG_TWOKEY_REBOOT_OTHER_MODE)
	#error "CONFIG_ONEKEY_REBOOT_OTHER_MODE and CONFIG_TWOKEY_REBOOT_OTHER_MODE can't be opened at the same time"
#else
#endif
/********************************************************************/
