...
static struct device_attribute attrs[] = {
	__ATTR(open, 0444,			synaptics_rmi4_show_error,			rmidev_sysfs_open_store),
	__ATTR(release, 0444,			synaptics_rmi4_show_error,			rmidev_sysfs_release_store),
	__ATTR(attn_state, 0444,			rmidev_sysfs_attn_state_show,			synaptics_rmi4_store_error),
//	__ATTR_NULL,
};
