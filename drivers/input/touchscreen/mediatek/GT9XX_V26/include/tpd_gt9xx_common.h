...
#if defined(CONFIG_HCT_GTP_HALL_CFG)|| __HCT_CONFIG_HCT_GTP_HALL_CFG__
#define GTP_HALL_CLOSE_CFG   1
#else
#define GTP_HALL_CLOSE_CFG   0
#endif
...
#if defined(__HCT_TPD_PROXIMITY_SUPPORT__)
#if __HCT_TPD_PROXIMITY_SUPPORT__
	#undef TPD_PROXIMITY
	#define TPD_PROXIMITY					// if need the PS funtion,enable this MACRO
#endif
#endif
...
a sample config, send this config should cause the chip cannot work normally*/
        ...
        #define CTP_CFG_GROUP0  __HCT_CTP_CFG_GROUP0__
    #else
...
#define CTP_CFG_GROUP1_HALLCLOSE __HCT_CTP_CFG_GROUP1_HALLCLOSE__
#else
...
#define GTP_GPIO_AS_INT(pin);    	tpd_gpio_as_int_bias_dis(pin);
