...
static char msg_tpgesture_status_value[5] = {};
 char msg_tpgesture_status=0;
char msg_tpgesture_value[10];
#endif
/*=============================================================*/
...
{      
	if(!strncmp(buf, "on", 2))
	{  
		sprintf(msg_tpgesture_status_value,"on");
		msg_tpgesture_status = 1;//status --- on     
	}        
	else
	{  
		sprintf(msg_tpgesture_status_value,"off");
		msg_tpgesture_status = 0;//status --- off    
	}
	return count;
}
