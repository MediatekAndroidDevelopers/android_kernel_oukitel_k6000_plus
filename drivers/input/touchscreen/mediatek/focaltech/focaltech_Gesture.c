...
static void fts_check_gesture(struct input_dev *input_dev,int gesture_id)
{
	...
	{
	        case GESTURE_LEFT:
				sprintf(ft_tpgesture_value,"LEFT");
				tpgesture_hander();
				break;
	        case GESTURE_RIGHT:
				sprintf(ft_tpgesture_value,"RIGHT");
				tpgesture_hander();
				break;
	        case GESTURE_UP:
        		sprintf(ft_tpgesture_value,"UP");
				tpgesture_hander();
				break;
	        case GESTURE_DOWN:
				sprintf(ft_tpgesture_value,"DOWN");
				tpgesture_hander();
				break;
	        case GESTURE_DOUBLECLICK:
                ...
                //input_sync(input_dev);
                sprintf(ft_tpgesture_value,"DOUBCLICK");
				tpgesture_hander();
	                break;
			case GESTURE_C:
				sprintf(ft_tpgesture_value,"c");
				tpgesture_hander();
				break;
	        case GESTURE_O:
				sprintf(ft_tpgesture_value,"o");
				tpgesture_hander();
				break;
			
	        case GESTURE_W:
				sprintf(ft_tpgesture_value,"w");
				tpgesture_hander();
				break;

	        case GESTURE_M:
				sprintf(ft_tpgesture_value,"m");
				tpgesture_hander();
				break;

	        case GESTURE_E:
				sprintf(ft_tpgesture_value,"e");
				tpgesture_hander();
				break;

	        case GESTURE_L:
				sprintf(ft_tpgesture_value,"l");
				tpgesture_hander();
				break;

	        case GESTURE_S:
				sprintf(ft_tpgesture_value,"s");
				tpgesture_hander();
				break;

	        case GESTURE_V:
				sprintf(ft_tpgesture_value,"v");
				tpgesture_hander();
				break;

	        case GESTURE_Z:
				sprintf(ft_tpgesture_value,"z");
				tpgesture_hander();
				break;
...
int fts_read_Gestruedata(void)
{
    ...
    ret = fts_i2c_read(fts_i2c_client, buf, 1, buf, FTS_GESTRUE_POINTS_HEADER);
        TPD_DMESG( "tpd read FTS_GESTRUE_POINTS_HEADER.\n");
	...
	TPD_DMESG("readfts_updateinfo_curr.CHIP_ID %x;\n ",fts_updateinfo_curr.CHIP_ID);
    /* FW */
