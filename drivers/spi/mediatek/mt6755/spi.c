...
#endif
//////////////////////////////////////////
// TrustKernel add 2016-12-20 start
/////////////////////////////////////////
...
#endif
//////////////////////////////////////////
// TrustKernel add 2016-12-20 end
/////////////////////////////////////////
...
#if 0  //copy to mt_spi_hal.h by hsl
struct mt_spi_t {
...
extern int hct_get_max_finger_spi_cs_number(void);
////////////////////////////////////////////////////
// TrustKernel add 2016-12-25 start
////////////////////////////////////////////////////
...
static int __init mt_spi_probe(struct platform_device *pdev)
{
	...
	master->num_chipselect = hct_get_max_finger_spi_cs_number();
#else
...
////////////////////////////////////////////////////
// TrustKernel add 2016-12-25 end
////////////////////////////////////////////////////
